...
CREATE TABLE `sys_user` (
  ...
  `del_flag` tinyint(4) DEFAULT '0' COMMENT '是否删除 -1：以删除 0：正常',
  PRIMARY KEY (`id`),
...
CREATE TABLE `sys_dept` (
  ...
  `parent_id` bigint(20) DEFAULT NULL COMMENT '上级机构ID，一般机构为0',
...
CREATE TABLE `sys_role_menu` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `last_update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
  `last_update_tiem` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `sys_login_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `user_name` varchar(50) DEFAULT NULL COMMENT '用户名',
  `status` varchar(50) DEFAULT NULL COMMENT '登陆状态（online:在线，登陆初始状态，方便统计在线人数；login:退出登陆后将online设置为login；logout退出登陆',
  `ip` varchar(64) DEFAULT NULL COMMENT 'IP地址',
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `last_update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
